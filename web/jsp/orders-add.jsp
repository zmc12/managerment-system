			...
			<section class="content"> <!--订单信息-->
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control pull-right"
								    placeholder="手机号码" name="phoneNum"
								   value="">

						</div>
						<div class="col-md-2 title">证件类型</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="证件类型 0身份证 1护照 2军官证"
								   name="credentialsType" value="">
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="旅客类型(人群) 0 成人 1 儿童"
								   name="travellerType" value="">
						</div>
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="会员"
                                   name="nickname" value="">
                        </div>
                        ...
                        <%--<div class="col-md-2 title">productId</div>--%>
					...
					<div class="box-tools text-center">
						...
						<button type="submit" class="btn bg-default">保存</button>
					</div>
					<div class="box-tools text-center">
